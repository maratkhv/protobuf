...
func (c *authClient) GetPublicKey(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*GetPublicKeyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedAuthServer) GetPublicKey(context.Context, *empty.Empty) (*GetPublicKeyResponse, error) {
...
func _Auth_GetPublicKey_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).GetPublicKey(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
